...
Presentation reporting should use the HTML-PPT skill from <https://github.com/lewislulu/html-ppt-skill>. Store source decks in `presentations/`, rendered outputs in `reports/`, and include speaker notes for human review.
